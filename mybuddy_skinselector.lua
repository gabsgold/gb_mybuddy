...
function ClothShop()
	...
	drawTxt(0.177, 0.066, 0.25, 0.03, 0.40,"MyBuddy Shop",255,255,255,255) -- header
	...
	if cmenu.show == 1 then
		...
		drawTxt(0.177, 0.202, 0.25, 0.03, 0.40,"MyBuddy Model",255,255,255,255) -- row_2 (+0.037)
	...
	elseif cmenu.show == 2 then
		...
		--
		if GetNumberOfPedDrawableVariations(mybot, cmenu.field-1) ~= 0 and GetNumberOfPedDrawableVariations(mybot, cmenu.field-1) ~= false then
			DrawRect(0.328,0.142,0.175,0.014,28,134,238,150)
			local link = 0.138/(GetNumberOfPedDrawableVariations(mybot, cmenu.field-1)-1)
			...
			local link = 0.138/(GetNumberOfPedTextureVariations(mybot, cmenu.field-1, draw[1])-1)
			...
			if IsControlJustPressed(1, 189) or IsDisabledControlJustPressed(1, 189) then -- left
				...
				elseif cmenu.row == 2 then
					...
					draw[2] = 0
					SetPedComponentVariation(mybot, cmenu.field-1, draw[1], draw[2], draw[3])
			...
			if IsControlJustPressed(1, 190) or IsDisabledControlJustPressed(1, 190) then -- right
				...
				elseif cmenu.row == 2 then
					if draw[1] < GetNumberOfPedDrawableVariations(mybot, cmenu.field-1)-1 then draw[1] = draw[1]+1 else draw[1] = GetNumberOfPedDrawableVariations(mybot, cmenu.field-1)-1 end
					draw[2] = 0
					SetPedComponentVariation(mybot, cmenu.field-1, draw[1], draw[2], draw[3])
				elseif cmenu.row == 3 then
					if draw[2] < GetNumberOfPedTextureVariations(mybot, cmenu.field-1, draw[1])-1 then draw[2] = draw[2]+1 else draw[2] = GetNumberOfPedTextureVariations(mybot, cmenu.field-1, draw[1])-1 end
					SetPedComponentVariation(mybot, cmenu.field-1, draw[1], draw[2], draw[3])
				elseif cmenu.row == 4 then
	...
	elseif cmenu.show == 3 then
		...
		drawTxt(0.328,0.093,0.175,0.035, 0.40,draw_str,255,255,255,255)
		--
		if GetNumberOfPedPropDrawableVariations(mybot, cmenu.field-1) ~= 0 and GetNumberOfPedPropDrawableVariations(mybot, cmenu.field-1) ~= false then
			DrawRect(0.328,0.142,0.175,0.014,28,134,238,150)
			local link = 0.138/(GetNumberOfPedPropDrawableVariations(mybot, cmenu.field-1)-1)
			...
			-- row_3
			DrawRect(0.328,0.179,0.175,0.014,28,134,238,150) -- bar_main
			local link = 0.138/(GetNumberOfPedPropTextureVariations(mybot, cmenu.field-1, prop[1])-1)
			...
			if IsControlJustPressed(1, 189) or IsDisabledControlJustPressed(1, 189) then -- left
				...
				elseif cmenu.row == 2 then
					...
					prop[2] = 0
					SetPedPropIndex(mybot, cmenu.field-1, prop[1], prop[2], prop[3])
				elseif cmenu.row == 3 then
			...
			if IsControlJustPressed(1, 190) or IsDisabledControlJustPressed(1, 190) then -- right
				...
				elseif cmenu.row == 2 then
					if prop[1] < GetNumberOfPedPropDrawableVariations(mybot, cmenu.field-1)-1 then prop[1] = prop[1]+1 else prop[1] = GetNumberOfPedPropDrawableVariations(mybot, cmenu.field-1)-1 end
					prop[2] = 0
					SetPedPropIndex(mybot, cmenu.field-1, prop[1], prop[2], prop[3])
				elseif cmenu.row == 3 then
					if prop[2] < GetNumberOfPedPropTextureVariations(mybot, cmenu.field-1, prop[1])-1 then prop[2] = prop[2]+1 else prop[2] = GetNumberOfPedPropTextureVariations(mybot, cmenu.field-1, prop[1])-1 end
					SetPedPropIndex(mybot, cmenu.field-1, prop[1], prop[2], prop[3])
				end
			end
		else
	...
	elseif cmenu.show == 4 then
		local drawstr = string.format("ID: %d~n~Name: %s",model_id, mybotskins[model_id])
		drawTxt(0.28, 0.8, 0, 0, 0.40,drawstr,255,255,255,255)
		DrawRect(0.12,0.135,0.22,0.035,0,0,0,150)
		DrawRect(0.12,0.172,0.22,0.035,0,0,0,150)
		...
		drawTxt(0.177, 0.202, 0.25, 0.03, 0.40,"~b~MyBuddy Model",255,255,255,255)
		drawTxt(0.177, 0.239, 0.25, 0.03, 0.40,"Exit",255,255,255,255)
		DrawRect(0.328,0.051,0.18,0.049,0,0,0,150)
		drawTxt(0.382,0.048,0.175,0.035, 0.40,"MyBuddy Model",255,255,255,255)
		DrawRect(0.328,0.024,0.175,0.005,58,95,205,150)
		if cmenu.row == 1 then DrawRect(0.328,0.096,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.096,0.18,0.035,0,0,0,150) end
		if cmenu.row == 2 then DrawRect(0.328,0.133,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.133,0.18,0.035,0,0,0,150) end
		if cmenu.row == 3 then DrawRect(0.328,0.170,0.18,0.035,76,88,102,150) else DrawRect(0.328,0.170,0.18,0.035,0,0,0,150) end
		...
		drawTxt(0.328,0.093,0.175,0.035, 0.40,draw_str,255,255,255,255)
		draw_str = string.format("%s", mybotskins[model_id])
		...
		if IsControlJustPressed(1, 201) or IsDisabledControlJustPressed(1, 201) then -- Enter
			if cmenu.row == 1 or cmenu.row == 2 then
				ChangeToSkin(mybotskins[model_id])
			elseif cmenu.row == 3 then
				if text_in == 0 then
					text_in = 1
...
function ChangeToSkin(skin)
	...
	if IsModelInCdimage(model) and IsModelValid(model) and DoesEntityExist(mybot) then
		RequestModel(model)
		...
		mybot = CreatePed(4, model, ploff.x, ploff.y, ploff.z, 10.0, true, false)
